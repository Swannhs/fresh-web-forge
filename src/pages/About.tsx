        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow">
                ...
                <section className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
                    ...
                    <section className="flex flex-row items-center justify-center w-full px-10 pt-16">
                        <div className="relative w-full max-w-[1248px]">
                            <img
                                ...
                                className="w-full h-[800px] object-cover object-center rounded-3xl"
                                decoding="async"
                                sizes="min(max(100vw - 80px, 1px), 1248px)"
                            />
                        </div>
                    </section>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <div className="bg-gray-100 rounded-lg h-64 mb-4 overflow-hidden">
                                <img
                                    src="https://framerusercontent.com/images/MiV5wfTsEZQAcSVaX1laZOZkQc.jpg?scale-down-to=512"
                            ...
                            <p className="text-sm text-gray-600">
                                Immerse yourself in our meticulously curated selection, backed by over 30 years of
                                industry experience.
                            </p>
                        </div>
                        ...
                        <div>
                            <div className="bg-gray-100 rounded-lg h-64 mb-4 overflow-hidden">
                                <img
                                    src="https://framerusercontent.com/images/7IKyhgRDZPO1UJciT7DCqhB6lo.jpg?scale-down-to=512"
                            ...
                            <p className="text-sm text-gray-600">
                                Our products showcase flagship brands, embodying timeless innovation that ensures they
                                remain relevant and cutting edge for years.
                            </p>
                        </div>
                        ...
                        <div>
                            <div className="bg-gray-100 rounded-lg h-64 mb-4 overflow-hidden">
                                <img
                                    src="https://framerusercontent.com/images/4WDC0QNCxFeWMJczI7Vj0MpK6M.jpg?scale-down-to=512"
                            ...
                            <p className="text-sm text-gray-600">
                                Shop with confidence knowing that our products are sourced from reputable factories
                                worldwide, adhering to stringent compliance standards.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            <img
                                src="https://framerusercontent.com/images/vQAxeXQWUx7aC8ULw9roRgdzE.jpg?scale-down-to=1024"
                                alt="Laptop setup"
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">
                                Our pursuit of excellence involves extensive exploration of top-tier factories globally,
                                ensuring our tech lineup upholds standards upheld by renowned brands. We forge strong
                                partnerships with these facilities, prioritizing factors like sustainability and ethical
                ...
                <section className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1">
                            ...
                            <p className="text-gray-600 mb-6">
                                At Etec, we eschew passing trends in favor of enduring value and utility. Our
                                commitment? To offer tech solutions that seamlessly integrate into your life, promising
                                years of reliable performance and timeless appeal.
                            </p>
                        ...
                        <div className="order-1 md:order-2">
                            <img
                                src="https://framerusercontent.com/images/5wWlzdU1I5v8dJZjHkXQ0jK0Nf0.jpg?scale-down-to=1024"
                ...
                <section className="bg-gray-50 py-16">
                    <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                            Be the first to know about the latest in tech trends, exclusive offers, and exciting product
                            launches by subscribing to our newsletter.
                        </p>
